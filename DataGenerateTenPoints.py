...
# Step 9: Define Multiple Starting Points
starting_points = [
    QgsPointXY(81.815,34.974),
    QgsPointXY(79.256,33.682),
    QgsPointXY(77.609,31.934),
    QgsPointXY(75.683,29.805),
    QgsPointXY(75.075,28.817),
    QgsPointXY(74.137,27.778),
    QgsPointXY(72.744,26.486),
    QgsPointXY(72.490,24.078),
    QgsPointXY(74.644,22.355),
    QgsPointXY(76.621,26.511)
]
    ...
    for angle in angles:
        for _ in range(num_points_per_line):
            ...
            end_point = QgsPointXY(
                start_point.x() + random_distance * np.cos(angle_rad),
                start_point.y() + random_distance * np.sin(angle_rad)
            )
            points.append((end_point.x(), end_point.y()))

            # Create line feature (corrected)
